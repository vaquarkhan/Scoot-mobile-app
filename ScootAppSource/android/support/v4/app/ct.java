  ...
  implements bn, bo
{
  ...
  {
    this.c.add(cs.a(this.a, paramcm));
  }
  
  public Notification b()
  {
    Notification localNotification = this.a.build();
    Object localObject = cs.a(localNotification);
    ...
    localObject = cs.a(this.c);
    if (localObject != null) {
      cs.a(localNotification).putSparseParcelableArray("android.support.actionExtras", (SparseArray)localObject);
    }
...
/* Location:              D:\Android\dex2jar-2.0\classes-dex2jar.jar!\android\support\v4\app\ct.class
