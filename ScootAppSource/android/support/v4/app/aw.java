...
final class aw
{
  ...
  private static void a(Transition paramTransition, bb parambb)
  {
    if (paramTransition != null) {
      paramTransition.setEpicenterCallback(new az(parambb));
    }
  }
  ...
  public static void a(View paramView1, View paramView2, Object paramObject1, ArrayList<View> paramArrayList1, Object paramObject2, ArrayList<View> paramArrayList2, Object paramObject3, ArrayList<View> paramArrayList3, Object paramObject4, ArrayList<View> paramArrayList4, Map<String, View> paramMap)
  {
    ...
    if (paramObject4 != null) {
      paramView1.getViewTreeObserver().addOnPreDrawListener(new ba(paramView1, (Transition)paramObject1, paramArrayList1, (Transition)paramObject2, paramArrayList2, (Transition)paramObject3, paramArrayList3, paramMap, paramArrayList4, (Transition)paramObject4, paramView2));
    }
  }
  ...
  {
    ((Transition)paramObject).setEpicenterCallback(new ax(c(paramView)));
  }
  ...
  public static void a(Object paramObject1, Object paramObject2, View paramView1, bc parambc, View paramView2, bb parambb, Map<String, String> paramMap, ArrayList<View> paramArrayList1, Map<String, View> paramMap1, Map<String, View> paramMap2, ArrayList<View> paramArrayList2)
  {
    if ((paramObject1 != null) || (paramObject2 != null))
    {
      ...
      if (parambc != null) {
        paramView1.getViewTreeObserver().addOnPreDrawListener(new ay(paramView1, (Transition)paramObject1, paramView2, parambc, paramMap, paramMap2, paramArrayList1));
      }
      a((Transition)paramObject1, parambb);
    }
  }
...
/* Location:              D:\Android\dex2jar-2.0\classes-dex2jar.jar!\android\support\v4\app\aw.class
