...
public final class bp
{
  ...
  {
    if ((a()) && (this.b != null)) {
      return ef.a(this.b, this.a, paramFloat1, paramFloat2);
    }
    return false;
  }
  ...
  {
    if ((a()) && (this.b != null)) {
      return ef.a(this.b, this.a, paramFloat1, paramFloat2, paramBoolean);
    }
    return false;
  }
  ...
  public boolean a(int paramInt)
  {
    ...
    if (a())
    {
      ...
      {
        if (ef.a(localViewParent, localView, this.a, paramInt))
        {
          this.b = localViewParent;
          ef.b(localViewParent, localView, this.a, paramInt);
          return true;
        }
  ...
  public boolean a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int[] paramArrayOfInt)
  {
    ...
    for (;;)
    {
      ef.a(this.b, this.a, paramInt1, paramInt2, paramInt3, paramInt4);
      if (paramArrayOfInt != null)
      {
        this.a.getLocationInWindow(paramArrayOfInt);
        paramArrayOfInt[0] -= j;
  ...
  public boolean a(int paramInt1, int paramInt2, int[] paramArrayOfInt1, int[] paramArrayOfInt2)
  {
    ...
    for (;;)
    {
      ...
      arrayOfInt[0] = 0;
      arrayOfInt[1] = 0;
      ef.a(this.b, this.a, paramInt1, paramInt2, arrayOfInt);
      if (paramArrayOfInt2 != null)
      {
        this.a.getLocationInWindow(paramArrayOfInt2);
...
/* Location:              D:\Android\dex2jar-2.0\classes-dex2jar.jar!\android\support\v4\view\bp.class
