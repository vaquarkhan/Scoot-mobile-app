  ...
  implements r
{
  ...
  public boolean a(MotionEvent paramMotionEvent)
  {
    ...
    if ((i6 & 0xFF) == 6)
    {
      ...
      i3 = bf.b(paramMotionEvent);
      i5 = bf.c(paramMotionEvent);
      i4 = 0;
      f1 = 0.0F;
      f2 = 0.0F;
      label66:
    ...
    for (;;)
    {
      ...
      break label53;
      label101:
      f2 += bf.c(paramMotionEvent, i4);
      f1 += bf.d(paramMotionEvent, i4);
    }
    label122:
    if (i1 != 0)
    {
    ...
    case 2: 
      do
      {
        ...
        do
        {
          ...
          f3 = bw.a(this.x, i4);
        } while (bw.b(this.x, i4) * f2 + f3 * f1 >= 0.0F);
        this.x.clear();
        return false;
        if (this.j != null)
        {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        else
        {
          ...
          i2 = bf.b(paramMotionEvent, 0);
          localVelocityTracker.computeCurrentVelocity(1000, this.d);
          f1 = bw.b(localVelocityTracker, i2);
          f2 = bw.a(localVelocityTracker, i2);
...
/* Location:              D:\Android\dex2jar-2.0\classes-dex2jar.jar!\android\support\v4\view\s.class
