...
public class q<K, V>
{
  ...
  public void a(q<? extends K, ? extends V> paramq)
  {
    int i = 0;
    int j = paramq.h;
    a(this.h + j);
    if (this.h == 0) {
      if (j > 0)
      {
        System.arraycopy(paramq.f, 0, this.f, 0, j);
        System.arraycopy(paramq.g, 0, this.g, 0, j << 1);
        this.h = j;
      }
    }
    for (;;)
...
/* Location:              D:\Android\dex2jar-2.0\classes-dex2jar.jar!\android\support\v4\g\q.class
