...
public class NestedScrollView
  ...
  implements bo, bq, bu
{
  private static final ba v = new ba();
  ...
  private final br x;
  private final android.support.v4.view.bp y;
  private float z;
  ...
  public NestedScrollView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    this.x = new br(this);
    this.y = new android.support.v4.view.bp(this);
  ...
  private void a(MotionEvent paramMotionEvent)
  {
    ...
    for (i1 = 1;; i1 = 0)
    {
      this.f = ((int)bf.d(paramMotionEvent, i1));
  ...
  private void g()
  {
    if (cb.a(this) != 2)
    {
      if (this.d == null)
      {
        ...
        this.d = new ah(localContext);
        this.e = new ah(localContext);
      }
      return;
    }
    this.d = null;
  ...
  {
    if ((bf.d(paramMotionEvent) & 0x2) != 0) {
    ...
    for (;;)
    {
      ...
      if (!this.j)
      {
        float f1 = bf.e(paramMotionEvent, 9);
        if (f1 != 0.0F)
        {
  ...
  public boolean onInterceptTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      if (i1 != -1)
      {
        int i2 = bf.a(paramMotionEvent, i1);
        if (i2 == -1)
        {
        ...
        {
          i1 = (int)bf.d(paramMotionEvent, i2);
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    while (this.j)
    {
      ...
      if (i2 < 0)
      {
        this.d.a(i1 / getHeight(), bf.c(paramMotionEvent, i3) / getWidth());
        if (!this.e.a()) {
          this.e.c();
        }
      }
      while ((this.d != null) && ((!this.d.a()) || (!this.e.a())))
      {
        ...
        if (i2 > i4)
        {
          this.e.a(i1 / getHeight(), 1.0F - bf.c(paramMotionEvent, i3) / getWidth());
          if (!this.d.a()) {
            this.d.c();
          }
        }
      ...
      if (this.j)
      {
        ...
        i1 = (int)bw.b(paramMotionEvent, this.q);
      ...
      break;
      a(paramMotionEvent);
      this.f = ((int)bf.d(paramMotionEvent, bf.a(paramMotionEvent, this.q)));
      break;
    }
  }
  ...
  public void setOnScrollChangeListener(bb parambb)
  {
    this.A = parambb;
  }
...
/* Location:              D:\Android\dex2jar-2.0\classes-dex2jar.jar!\android\support\v4\widget\NestedScrollView.class
