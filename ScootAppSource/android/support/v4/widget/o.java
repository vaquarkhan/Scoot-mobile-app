  ...
  implements t, Filterable
{
  ...
  public o(Context paramContext, Cursor paramCursor, boolean paramBoolean)
  {
    if (paramBoolean) {}
    for (int j = 1;; j = 2)
    {
  ...
  void a(Context paramContext, Cursor paramCursor, int paramInt)
  {
    ...
    for (this.g = new r(this, null);; this.g = null)
    {
      if (bool)
      {
        if (this.f != null) {
...
/* Location:              D:\Android\dex2jar-2.0\classes-dex2jar.jar!\android\support\v4\widget\o.class
