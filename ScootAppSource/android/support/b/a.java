...
public final class a
{
  ...
  public static void a(Context paramContext)
  {
    ...
    try
    {
      ...
      List localList = f.a(paramContext, localApplicationInfo, localFile, false);
      if (a(localList))
      {
    ...
    catch (Throwable localThrowable)
    {
      for (;;)
      {
        ...
        paramContext = f.a(paramContext, localApplicationInfo, localThrowable, true);
        if (!a(paramContext)) {
          break;
        }
...
/* Location:              D:\Android\dex2jar-2.0\classes-dex2jar.jar!\android\support\b\a.class
