  ...
  extends cx
{
  ...
  public a(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    this.f = paramContext.getInt(R.styleable.ForegroundLinearLayout_android_foregroundGravity, this.f);
    ...
    this.a = paramContext.getBoolean(R.styleable.ForegroundLinearLayout_foregroundInsidePadding, true);
...
/* Location:              D:\Android\dex2jar-2.0\classes-dex2jar.jar!\android\support\design\internal\a.class
