  ...
  extends al
{
  ...
  ar(de paramde, ax paramax)
  {
    super(paramde, paramax);
    if (paramde.isInEditMode()) {}
    for (paramde = null;; paramde = AnimationUtils.loadInterpolator(this.k.getContext(), 17563661))
    {
      this.m = paramde;
      return;
    }
  ...
  void a(Rect paramRect)
  {
    if (this.l.b())
    {
      float f1 = this.l.a();
      float f2 = a() + this.g;
      int i = (int)Math.ceil(aw.b(f2, f1, false));
      int j = (int)Math.ceil(aw.a(f2, f1, false));
...
/* Location:              D:\Android\dex2jar-2.0\classes-dex2jar.jar!\android\support\design\widget\ar.class
