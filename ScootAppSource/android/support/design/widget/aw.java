  ...
  extends a
{
  ...
  public aw(Resources paramResources, Drawable paramDrawable, float paramFloat1, float paramFloat2, float paramFloat3)
  {
    super(paramDrawable);
    this.l = paramResources.getColor(R.color.design_fab_shadow_start_color);
    this.m = paramResources.getColor(R.color.design_fab_shadow_mid_color);
    this.n = paramResources.getColor(R.color.design_fab_shadow_end_color);
    this.b = new Paint(5);
...
/* Location:              D:\Android\dex2jar-2.0\classes-dex2jar.jar!\android\support\design\widget\aw.class
