...
final class r
{
  ...
  public r(Context paramContext, bh parambh, Window paramWindow)
  {
    this.a = paramContext;
    this.b = parambh;
    this.c = paramWindow;
    this.M = new ad(parambh);
  ...
  private void a(ViewGroup paramViewGroup, View paramView, int paramInt1, int paramInt2)
  {
    ...
    {
      cb.a(paramView, paramInt1, paramInt2);
      if (localView2 != null) {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        if (this.e != null)
        {
          this.w.setOnScrollChangeListener(new t(this, paramView, (View)localObject));
          this.w.post(new u(this, paramView, (View)localObject));
          return;
        }
        if (this.f != null)
        {
          this.f.setOnScrollListener(new v(this, paramView, (View)localObject));
          this.f.post(new w(this, paramView, (View)localObject));
          return;
        }
        if (paramView != null) {
...
/* Location:              D:\Android\dex2jar-2.0\classes-dex2jar.jar!\android\support\v7\a\r.class
