  ...
  implements View.OnTouchListener
{
  ...
  private boolean b(MotionEvent paramMotionEvent)
  {
    ...
    if ((localObject == null) || (!((dd)localObject).k())) {}
    do
    {
      return false;
      localObject = dd.a((dd)localObject);
    } while ((localObject == null) || (!((dh)localObject).isShown()));
    MotionEvent localMotionEvent = MotionEvent.obtainNoHistory(paramMotionEvent);
    b(localView, localMotionEvent);
    a((View)localObject, localMotionEvent);
    boolean bool2 = ((dh)localObject).a(localMotionEvent, this.i);
    localMotionEvent.recycle();
    int k = bf.a(paramMotionEvent);
    if ((k != 1) && (k != 3))
    {
      k = 1;
      if ((!bool2) || (k == 0)) {
...
/* Location:              D:\Android\dex2jar-2.0\classes-dex2jar.jar!\android\support\v7\widget\di.class
