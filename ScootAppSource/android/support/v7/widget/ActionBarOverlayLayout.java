  ...
  implements bq, cc
{
  ...
  public void draw(Canvas paramCanvas)
  {
    ...
    label82:
    for (int i1 = (int)(this.e.getBottom() + cb.p(this.e) + 0.5F);; i1 = 0)
    {
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      for (((Rect)localObject).bottom += 0;; ((Rect)localObject).bottom += 0)
      {
        ...
        i3 = hc.a(i4, cb.l(this.d));
        i4 = getPaddingLeft();
        i5 = getPaddingRight();
        i2 = Math.max(i2 + (getPaddingTop() + getPaddingBottom()), getSuggestedMinimumHeight());
        setMeasuredDimension(cb.a(Math.max(i1 + (i4 + i5), getSuggestedMinimumWidth()), paramInt1, i3), cb.a(i2, paramInt2, i3 << 16));
        return;
        i2 = 0;
        break;
        label448:
...
/* Location:              D:\Android\dex2jar-2.0\classes-dex2jar.jar!\android\support\v7\widget\ActionBarOverlayLayout.class
