  ...
  implements d
{
  ...
  private void l()
  {
    ...
    if (this.H.getSuggestAuthority() != null)
    {
      this.x = new gd(getContext(), this, this.H, this.M);
      this.c.setAdapter(this.x);
      gd localgd = (gd)this.x;
      i1 = i2;
      if (this.A) {
        i1 = 2;
      }
  ...
  public o getSuggestionsAdapter()
  {
    return this.x;
  }
  ...
  public void setOnCloseListener(fs paramfs)
  {
    this.r = paramfs;
  }
  ...
  public void setOnQueryTextListener(ft paramft)
  {
    this.q = paramft;
  }
  ...
  public void setOnSuggestionListener(fu paramfu)
  {
    this.t = paramfu;
  }
  ...
  public void setSuggestionsAdapter(o paramo)
  {
    this.x = paramo;
    this.c.setAdapter(this.x);
  }
...
/* Location:              D:\Android\dex2jar-2.0\classes-dex2jar.jar!\android\support\v7\widget\SearchView.class
