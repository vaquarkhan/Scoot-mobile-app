  ...
  implements android.support.v4.view.o
{
  ...
  public void b(boolean paramBoolean)
  {
    ...
    if (this.c != null)
    {
      ...
      while (i1 < i4)
      {
        android.support.v4.view.n localn = ((android.support.v7.view.menu.m)((ArrayList)localObject).get(i1)).a();
        if (localn != null) {
          localn.a(this);
        }
        i1 += 1;
...
/* Location:              D:\Android\dex2jar-2.0\classes-dex2jar.jar!\android\support\v7\widget\k.class
