  ...
  extends a
{
  ...
  public ActionBarContextView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    paramContext = gm.a(paramContext, paramAttributeSet, R.styleable.ActionMode, paramInt, 0);
  ...
  public void a(b paramb)
  {
    ...
    for (;;)
    {
      this.i.findViewById(R.id.action_mode_close_button).setOnClickListener(new e(this, paramb));
      paramb = (i)paramb.b();
      if (this.d != null) {
        this.d.f();
      }
...
/* Location:              D:\Android\dex2jar-2.0\classes-dex2jar.jar!\android\support\v7\widget\ActionBarContextView.class
