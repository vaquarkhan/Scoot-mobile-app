...
final class cz
{
  ...
  cz(LinearLayoutManager paramLinearLayoutManager) {}
  
  private boolean a(View paramView, fa paramfa)
  {
    paramView = (ep)paramView.getLayoutParams();
    return (!paramView.c()) && (paramView.e() >= 0) && (paramView.e() < paramfa.e());
  }
...
/* Location:              D:\Android\dex2jar-2.0\classes-dex2jar.jar!\android\support\v7\widget\cz.class
