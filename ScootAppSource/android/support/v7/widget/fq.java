  ...
  implements View.OnLongClickListener
{
  ...
  public fq(fm paramfm, Context paramContext, d paramd, boolean paramBoolean)
  {
    super(paramContext, null, R.attr.actionBarTabStyle);
    this.c = paramd;
    paramfm = gm.a(paramContext, null, this.b, R.attr.actionBarTabStyle, 0);
    if (paramfm.f(0)) {
      setBackgroundDrawable(paramfm.a(0));
    }
    paramfm.a();
    if (paramBoolean) {
      setGravity(8388627);
  ...
  public void a()
  {
    ...
    if (localObject3 != null)
    {
      ...
      if (this.e == null)
      {
        ...
        cy localcy = new cy(-2, -2);
        localcy.h = 16;
        ((ImageView)localObject4).setLayoutParams(localcy);
      ...
      if (this.d == null)
      {
        ...
        localObject4 = new cy(-2, -2);
        ((cy)localObject4).h = 16;
...
/* Location:              D:\Android\dex2jar-2.0\classes-dex2jar.jar!\android\support\v7\widget\fq.class
