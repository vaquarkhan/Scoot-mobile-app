  ...
  implements View.OnClickListener
{
  ...
  public gd(Context paramContext, SearchView paramSearchView, SearchableInfo paramSearchableInfo, WeakHashMap<String, Drawable.ConstantState> paramWeakHashMap)
  {
  ...
  public View a(Context paramContext, Cursor paramCursor, ViewGroup paramViewGroup)
  {
    ...
    paramContext.setTag(new ge(paramContext));
  ...
  {
    paramContext = (ge)paramView.getTag();
    if (this.x != -1) {}
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    catch (RuntimeException paramView)
    {
      ...
      if (paramViewGroup != null) {
        ((ge)paramViewGroup.getTag()).a.setText(paramView.toString());
      }
    }
...
/* Location:              D:\Android\dex2jar-2.0\classes-dex2jar.jar!\android\support\v7\widget\gd.class
