  ...
  extends ViewGroup
{
  ...
  private void a(int paramInt)
  {
    ...
    for (;;)
    {
      localdd.f(Math.min(this.b.a(), this.h));
      localdd.c();
      if (this.a != null) {
        this.a.a(true);
      }
      localdd.m().setContentDescription(getContext().getString(R.string.abc_activitychooserview_choose_application));
      return;
      bool = false;
      break;
      label190:
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    measureChild(localcx, paramInt1, i1);
    setMeasuredDimension(localcx.getMeasuredWidth(), localcx.getMeasuredHeight());
  }
...
/* Location:              D:\Android\dex2jar-2.0\classes-dex2jar.jar!\android\support\v7\widget\ActivityChooserView.class
