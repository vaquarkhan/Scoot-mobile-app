...
final class by
{
  ...
  View a(int paramInt1, int paramInt2)
  {
    ...
    while (i < j)
    {
      ...
      fd localfd = this.a.b(localView);
      if ((localfd.d() == paramInt1) && (!localfd.n()) && (!localfd.q()) && ((paramInt2 == -1) || (localfd.h() == paramInt2))) {
        return localView;
      }
      i += 1;
    }
...
/* Location:              D:\Android\dex2jar-2.0\classes-dex2jar.jar!\android\support\v7\widget\by.class
