...
final class gc
{
  ...
  private gc(StaggeredGridLayoutManager paramStaggeredGridLayoutManager, int paramInt)
  {
    this.d = paramInt;
  }
  ...
  void a()
  {
    ...
    fz localfz = c((View)localObject);
    this.a = this.e.a.a((View)localObject);
    if (localfz.f)
    {
      localObject = this.e.f.f(localfz.e());
  ...
  fz c(View paramView)
  {
    return (fz)paramView.getLayoutParams();
  }
...
/* Location:              D:\Android\dex2jar-2.0\classes-dex2jar.jar!\android\support\v7\widget\gc.class
