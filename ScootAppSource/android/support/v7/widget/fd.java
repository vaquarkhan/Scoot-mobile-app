...
public abstract class fd
{
  ...
  private boolean C()
  {
    return ((this.l & 0x10) == 0) && (cb.c(this.a));
  }
  ...
  void a(int paramInt, boolean paramBoolean)
  {
    ...
    if (this.a.getLayoutParams() != null) {
      ((ep)this.a.getLayoutParams()).c = true;
    }
  }
  
  void a(eu parameu, boolean paramBoolean)
  {
    this.o = parameu;
    this.p = paramBoolean;
  }
...
/* Location:              D:\Android\dex2jar-2.0\classes-dex2jar.jar!\android\support\v7\widget\fd.class
