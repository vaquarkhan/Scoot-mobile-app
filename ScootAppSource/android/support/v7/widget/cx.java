  ...
  extends ViewGroup
{
  ...
  public cx(Context paramContext, AttributeSet paramAttributeSet)
  {
    this(paramContext, paramAttributeSet, 0);
  }
  
  public cx(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    super(paramContext, paramAttributeSet, paramInt);
    paramContext = gm.a(paramContext, paramAttributeSet, R.styleable.LinearLayoutCompat, paramInt, 0);
  ...
  private void c(int paramInt1, int paramInt2)
  {
    ...
    while (i1 < paramInt1)
    {
      ...
      {
        cy localcy = (cy)localView.getLayoutParams();
        if (localcy.width == -1)
        {
          int i3 = localcy.height;
          localcy.height = localView.getMeasuredHeight();
  ...
  private void d(int paramInt1, int paramInt2)
  {
    ...
    while (i1 < paramInt1)
    {
      ...
      if (localView.getVisibility() != 8)
      {
        ...
        if (localcy.height == -1)
        {
          int i3 = localcy.width;
          localcy.width = localView.getMeasuredWidth();
  ...
  void a(int paramInt1, int paramInt2)
  {
    ...
    if (i7 < i15)
    {
      ...
      localcy = (cy)localView.getLayoutParams();
      f1 += localcy.g;
      if ((i17 == 1073741824) && (localcy.height == 0) && (localcy.g > 0.0F))
      {
        i5 = this.f;
        this.f = Math.max(i5, localcy.topMargin + i5 + localcy.bottomMargin);
        i11 = 1;
        i10 = i4;
        if ((i18 >= 0) && (i18 == i7 + 1)) {
          this.c = this.f;
        }
        if ((i7 < i18) && (localcy.g > 0.0F)) {
      ...
      else
      {
        ...
        for (i11 = this.f;; i11 = 0)
        {
          ...
          i10 = this.f;
          this.f = Math.max(i10, i10 + i12 + localcy.topMargin + localcy.bottomMargin + b(localView));
          i10 = i4;
          i11 = i5;
          if (!bool) {
            break;
      ...
      i5 = 0;
      if ((i16 == 1073741824) || (localcy.width != -1)) {
        break label1671;
      }
      i4 = 1;
      i5 = 1;
    ...
    for (;;)
    {
      i8 = localcy.leftMargin;
      i8 = localcy.rightMargin + i8;
      i12 = localView.getMeasuredWidth() + i8;
      int i14 = Math.max(i2, i12);
      int i13 = hc.a(i1, cb.l(localView));
      if ((i3 != 0) && (localcy.width == -1))
      {
        i3 = 1;
        label611:
        if (localcy.g <= 0.0F) {
        ...
        if (i7 < i15)
        {
          ...
          for (;;)
          {
            ...
            else
            {
              localcy = (cy)localView.getLayoutParams();
              i10 = this.f;
              i11 = localcy.topMargin;
              this.f = Math.max(i10, localcy.bottomMargin + (i10 + i4 + i11) + b(localView));
            }
          }
        }
      }
      this.f += getPaddingTop() + getPaddingBottom();
      i11 = cb.a(Math.max(this.f, getSuggestedMinimumHeight()), paramInt2, 0);
        ...
        for (;;)
        {
          if (i7 < i15)
          {
            ...
            else
            {
              ...
              i9 = (int)(i5 * f2 / f1);
              i12 = getChildMeasureSpec(paramInt1, getPaddingLeft() + getPaddingRight() + localcy.leftMargin + localcy.rightMargin, localcy.width);
              if ((localcy.height != 0) || (i17 != 1073741824))
              {
                ...
                i1 = hc.a(i1, cb.l(localView) & 0xFF00);
                i6 = i5 - i9;
                i5 = i1;
                f1 -= f2;
                i1 = i6;
      ...
      for (;;)
      {
        i9 = localcy.leftMargin + localcy.rightMargin;
        ...
        for (i2 = 1;; i2 = 0)
        {
          ...
          i10 = localcy.topMargin;
          this.f = Math.max(i3, localcy.bottomMargin + (i9 + i3 + i10) + b(localView));
          i3 = i6;
          i6 = i1;
          i1 = i5;
          i5 = i6;
        ...
        for (;;)
        {
          ...
          for (;;)
          {
            setMeasuredDimension(cb.a(Math.max(i2 + (getPaddingLeft() + getPaddingRight()), getSuggestedMinimumWidth()), paramInt1, i1), i11);
            if (i8 != 0) {
              c(i15, paramInt2);
            }
            return;
            ...
            for (;;)
            {
              i5 += 1;
              break;
              if (((cy)localView.getLayoutParams()).g > 0.0F) {
  ...
  void a(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    for (;;)
    {
      ...
      if (localView.getVisibility() != 8)
      {
        ...
        switch (v.a(paramInt3, cb.h(this)) & 0x7)
        {
        default: 
          paramInt3 = i1 + localcy.leftMargin;
          label257:
          if (c(paramInt1)) {
        ...
        for (;;)
        {
          paramInt2 += localcy.topMargin;
          a(localView, paramInt3, paramInt2 + a(localView), i7, i8);
          paramInt2 += localcy.bottomMargin + i8 + b(localView);
          paramInt1 = a(localView, paramInt1) + paramInt1;
          break;
          paramInt3 = (i2 - i1 - i4 - i7) / 2 + i1 + localcy.leftMargin - localcy.rightMargin;
          break label257;
          paramInt3 = i2 - i3 - i7 - localcy.rightMargin;
          break label257;
          return;
        }
      }
  ...
  void a(Canvas paramCanvas)
  {
    ...
    while (i1 < i2)
    {
      ...
      {
        localcy = (cy)localView.getLayoutParams();
        a(paramCanvas, localView.getTop() - localcy.topMargin - this.m);
      }
      i1 += 1;
    }
    if (c(i2))
    ...
    for (i1 = getHeight() - getPaddingBottom() - this.m;; i1 = localcy.bottomMargin + i1)
    {
      a(paramCanvas, i1);
      return;
      label124:
  ...
  public cy b(AttributeSet paramAttributeSet)
  {
    return new cy(getContext(), paramAttributeSet);
  }
  
  protected cy b(ViewGroup.LayoutParams paramLayoutParams)
  {
    return new cy(paramLayoutParams);
  }
  ...
  void b(int paramInt1, int paramInt2)
  {
    ...
    cy localcy = (cy)localView.getLayoutParams();
    f1 += localcy.g;
    if ((i18 == 1073741824) && (localcy.width == 0) && (localcy.g > 0.0F)) {
      if (i12 != 0)
      {
        this.f += localcy.leftMargin + localcy.rightMargin;
        label421:
        if (!bool1) {
          break label727;
        }
        ...
        label450:
        i5 = 0;
        if ((i17 == 1073741824) || (localcy.height != -1)) {
          break label2365;
        }
        i4 = 1;
        i5 = 1;
    ...
    for (;;)
    {
      i7 = localcy.topMargin;
      i7 = localcy.bottomMargin + i7;
      i13 = localView.getMeasuredHeight() + i7;
      int i14 = hc.a(i2, cb.l(localView));
      if (bool1)
      {
      ...
      for (;;)
      {
        ...
        break;
        i10 = this.f;
        this.f = Math.max(i10, localcy.leftMargin + i10 + localcy.rightMargin);
        break label421;
        label727:
        i11 = 1;
        i10 = i4;
        ...
        for (this.f += localcy.leftMargin + i13 + localcy.rightMargin + b(localView);; this.f = Math.max(i10, i10 + i13 + localcy.leftMargin + localcy.rightMargin + b(localView)))
        {
          i10 = i4;
          i11 = i5;
          if (!bool2) {
      ...
      for (i9 = Math.max(i3, Math.max(localObject[3], Math.max(localObject[0], Math.max(localObject[1], localObject[2]))) + Math.max(arrayOfInt[3], Math.max(arrayOfInt[0], Math.max(arrayOfInt[1], arrayOfInt[2]))));; i9 = i3)
      {
          ...
          if (i3 < i16)
          {
            ...
            for (;;)
            {
              ...
              else
              {
                ...
                {
                  i10 = this.f;
                  i11 = localcy.leftMargin;
                  this.f = (localcy.rightMargin + (i11 + i4) + b(localView) + i10);
                }
                else
                {
                  i10 = this.f;
                  i11 = localcy.leftMargin;
                  this.f = Math.max(i10, localcy.rightMargin + (i10 + i4 + i11) + b(localView));
                }
              }
            }
          }
        ...
        i13 = cb.a(Math.max(this.f, getSuggestedMinimumWidth()), paramInt1, 0);
        ...
        for (;;)
        {
          ...
          if (f2 > 0.0F)
          {
            i9 = (int)(i4 * f2 / f1);
            i8 = i4 - i9;
            i10 = getChildMeasureSpec(paramInt2, getPaddingTop() + getPaddingBottom() + localcy.topMargin + localcy.bottomMargin, localcy.height);
            if ((localcy.width != 0) || (i18 != 1073741824))
            {
              ...
              i5 = hc.a(i5, cb.l(localView) & 0xFF000000);
              f1 -= f2;
              i4 = i8;
            }
          }
          for (;;)
          {
            if (i12 != 0)
            {
              this.f += localView.getMeasuredWidth() + localcy.leftMargin + localcy.rightMargin + b(localView);
              label1722:
              if ((i17 == 1073741824) || (localcy.height != -1)) {
                break label1979;
              }
              i8 = 1;
              label1741:
              i11 = localcy.topMargin + localcy.bottomMargin;
            ...
            for (i2 = this.e;; i2 = localcy.h)
            {
              ...
              i8 = this.f;
              this.f = Math.max(i8, localView.getMeasuredWidth() + i8 + localcy.leftMargin + localcy.rightMargin + b(localView));
              break label1722;
              i8 = 0;
              break label1741;
              i3 = i10;
            ...
            for (;;)
            {
              ...
              for (;;)
              {
                setMeasuredDimension(0xFF000000 & i1 | i13, cb.a(Math.max(i3 + (getPaddingTop() + getPaddingBottom()), getSuggestedMinimumHeight()), paramInt2, i1 << 16));
                if (i7 != 0) {
                  d(i16, paramInt1);
                }
                return;
                ...
                for (;;)
                {
                  i3 += 1;
                  break;
                  if (((cy)((View)localObject).getLayoutParams()).g > 0.0F) {
  ...
  void b(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    switch (v.a(paramInt2 & 0x800007, cb.h(this)))
    {
    default: 
      ...
      for (;;)
      {
        ...
        if (localView.getVisibility() != 8)
        {
          ...
          for (int i2 = localView.getBaseline();; i2 = -1)
          {
            ...
            for (;;)
            {
              paramInt3 += localcy.leftMargin;
              a(localView, paramInt3 + a(localView), paramInt1, i11, i12);
              paramInt3 += localcy.rightMargin + i11 + b(localView);
              paramInt1 = a(localView, i10) + paramInt2;
              break;
              i4 = i3 + localcy.topMargin;
              paramInt1 = i4;
              if (i2 == -1) {
                break label327;
              }
              ...
              break label327;
              paramInt1 = (i5 - i3 - i7 - i12) / 2 + i3 + localcy.topMargin - localcy.bottomMargin;
              break label327;
              i4 = i5 - i6 - i12 - localcy.bottomMargin;
              paramInt1 = i4;
              if (i2 == -1) {
                break label327;
              }
  ...
  void b(Canvas paramCanvas)
  {
    ...
    if (i1 < i3)
    {
      ...
      label92:
      for (int i2 = localcy.rightMargin + i2;; i2 = localView.getLeft() - localcy.leftMargin - this.l)
      {
        b(paramCanvas, i2);
        i1 += 1;
        break;
    ...
    for (;;)
    {
      ...
      if (bool)
      {
        i1 = localView.getLeft() - localcy.leftMargin - this.l;
      }
      else
      {
        i1 = localView.getRight();
        i1 = localcy.rightMargin + i1;
      }
    }
  }
  ...
  {
    return paramLayoutParams instanceof cy;
  }
  ...
  public int getBaseline()
  {
    ...
    for (;;)
    {
      return ((cy)localView.getLayoutParams()).topMargin + i1 + i2;
  ...
  public void onInitializeAccessibilityEvent(AccessibilityEvent paramAccessibilityEvent)
  {
    if (Build.VERSION.SDK_INT >= 14)
    {
      ...
      paramAccessibilityEvent.setClassName(cx.class.getName());
    }
  }
  ...
  public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo paramAccessibilityNodeInfo)
  {
    if (Build.VERSION.SDK_INT >= 14)
    {
      ...
      paramAccessibilityNodeInfo.setClassName(cx.class.getName());
    }
  }
...
/* Location:              D:\Android\dex2jar-2.0\classes-dex2jar.jar!\android\support\v7\widget\cx.class
