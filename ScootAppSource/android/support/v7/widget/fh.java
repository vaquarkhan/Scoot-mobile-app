  ...
  extends Drawable
{
  ...
  public fh(int paramInt, float paramFloat)
  {
    this.a = paramFloat;
    this.b = new Paint(5);
  ...
  private void a(Rect paramRect)
  {
    ...
    if (this.f)
    {
      float f1 = fi.a(this.e, this.a, this.g);
      float f2 = fi.b(this.e, this.a, this.g);
...
/* Location:              D:\Android\dex2jar-2.0\classes-dex2jar.jar!\android\support\v7\widget\fh.class
