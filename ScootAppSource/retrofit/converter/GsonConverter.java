  ...
  implements Converter
{
  ...
  public GsonConverter(k paramk)
  {
    this(paramk, "UTF-8");
  }
  
  public GsonConverter(k paramk, String paramString)
  {
    this.gson = paramk;
  ...
  public Object fromBody(retrofit.mime.TypedInput paramTypedInput, java.lang.reflect.Type paramType)
  {
    ...
    //   51: astore_3
    //   52: aload_0
    //   53: getfield 23	retrofit/converter/GsonConverter:gson	Lcom/google/a/k;
    //   56: aload_1
    //   57: aload_2
    //   58: invokevirtual 58	com/google/a/k:a	(Ljava/io/Reader;Ljava/lang/reflect/Type;)Ljava/lang/Object;
    //   61: astore_2
    //   62: aload_1
    //   63: ifnull +7 -> 70
    //   66: aload_1
  ...
  public TypedOutput toBody(Object paramObject)
  {
    try
    {
      paramObject = new GsonConverter.JsonTypedOutput(this.gson.b(paramObject).getBytes(this.charset), this.charset);
...
/* Location:              D:\Android\dex2jar-2.0\classes-dex2jar.jar!\retrofit\converter\GsonConverter.class
