...
{
  x(s params, ProgressDialog paramProgressDialog, ak paramak) {}
  ...
  public void a(String paramString, ParseException paramParseException)
  {
    ...
    try
    {
      ...
      if (a.a(this.b.b.c()) != 0)
      {
        new AlertDialog.Builder(s.b(this.c)).setTitle("Booking Status").setMessage("Booking Cancelled Successfully").setPositiveButton(17039379, new y(this)).show();
        this.b.b.a(1);
        this.c.c();
...
/* Location:              D:\Android\dex2jar-2.0\classes-dex2jar.jar!\com\sagar\taxiapp\a\x.class
