  ...
  extends ParseObject
{
  ...
  <T extends ParseObject> o<T> fetchAsync(String paramString, o<Void> paramo)
  {
    synchronized (this.mutex)
    {
      if (getObjectId() == null)
      {
        localo = saveAsync(paramString, paramo);
        paramString = localo.d(new ParseInstallation.1(this, paramString, paramo));
        return paramString;
      }
      o localo = o.a(null);
    }
  ...
  {
    return super.handleFetchResultAsync(paramState).d(new ParseInstallation.3(this));
  }
  ...
  o<Void> handleSaveResultAsync(ParseObject.State paramState, ParseOperationSet paramParseOperationSet)
  {
    ...
    return paramParseOperationSet.d(new ParseInstallation.2(this));
  }
...
/* Location:              D:\Android\dex2jar-2.0\classes-dex2jar.jar!\com\parse\ParseInstallation.class
