  ...
  extends Service
{
  ...
  private static void dispatchOnServiceCreated(Service paramService)
  {
    ...
    if (arrayOfObject != null)
    {
      ...
      while (i < j)
      {
        ((PushService.ServiceLifecycleCallbacks)arrayOfObject[i]).onServiceCreated(paramService);
        i += 1;
      }
    }
  }
  ...
  private static void dispatchOnServiceDestroyed(Service paramService)
  {
    ...
    if (arrayOfObject != null)
    {
      ...
      while (i < j)
      {
        ((PushService.ServiceLifecycleCallbacks)arrayOfObject[i]).onServiceDestroyed(paramService);
        i += 1;
      }
    }
  }
  
  static void registerServiceLifecycleCallbacks(PushService.ServiceLifecycleCallbacks paramServiceLifecycleCallbacks)
  {
    try
    {
      if (serviceLifecycleCallbacks == null) {
  ...
  {
    switch (PushService.1.$SwitchMap$com$parse$PushType[ManifestInfo.getPushType().ordinal()])
    {
    default: 
      if (!loggedStartError)
      {
  ...
  static void unregisterServiceLifecycleCallbacks(PushService.ServiceLifecycleCallbacks paramServiceLifecycleCallbacks)
  {
    try
    {
...
/* Location:              D:\Android\dex2jar-2.0\classes-dex2jar.jar!\com\parse\PushService.class
