...
public class ParseConfig
{
  ...
  private static o<ParseConfig> getAsync(o<Void> paramo)
  {
    return ParseUser.getCurrentSessionTokenAsync().d(new ParseConfig.2(paramo));
  }
  ...
  public static o<ParseConfig> getInBackground()
  {
...
/* Location:              D:\Android\dex2jar-2.0\classes-dex2jar.jar!\com\parse\ParseConfig.class
