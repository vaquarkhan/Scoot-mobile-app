    ...
    for (;;)
    {
      ...
      synchronized (lock)
      {
        ...
        if (pushType == null)
        {
          ...
          if (localManifestCheckResult1 == ManifestInfo.ManifestCheckResult.MISSING_REQUIRED_DECLARATIONS) {
            continue;
          }
          i = 1;
          if (localManifestCheckResult2 == ManifestInfo.ManifestCheckResult.MISSING_REQUIRED_DECLARATIONS) {
            continue;
          }
          if ((!bool4) || (!bool1) || (i == 0)) {
            continue;
...
/* Location:              D:\Android\dex2jar-2.0\classes-dex2jar.jar!\com\parse\ManifestInfo.class
