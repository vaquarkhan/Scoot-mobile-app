...
final class ap
{
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3, Bitmap paramBitmap)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 21	com/mixpanel/android/c/ap:a	Landroid/graphics/Bitmap;
    //   6: ifnull +29 -> 35
    //   9: aload_0
    //   10: getfield 21	com/mixpanel/android/c/ap:a	Landroid/graphics/Bitmap;
    //   13: invokevirtual 31	android/graphics/Bitmap:getWidth	()I
    //   16: iload_1
    //   17: if_icmpne +18 -> 35
    //   20: aload_0
    //   21: getfield 21	com/mixpanel/android/c/ap:a	Landroid/graphics/Bitmap;
    ...
    //   44: putfield 21	com/mixpanel/android/c/ap:a	Landroid/graphics/Bitmap;
    //   47: aload_0
    //   48: getfield 21	com/mixpanel/android/c/ap:a	Landroid/graphics/Bitmap;
    //   51: ifnull +11 -> 62
    //   54: aload_0
    //   55: getfield 21	com/mixpanel/android/c/ap:a	Landroid/graphics/Bitmap;
    //   58: iload_3
    //   59: invokevirtual 47	android/graphics/Bitmap:setDensity	(I)V
    //   62: aload_0
    //   63: getfield 21	com/mixpanel/android/c/ap:a	Landroid/graphics/Bitmap;
    //   66: ifnull +25 -> 91
    //   69: new 49	android/graphics/Canvas
    //   72: dup
    //   73: aload_0
    //   74: getfield 21	com/mixpanel/android/c/ap:a	Landroid/graphics/Bitmap;
    //   77: invokespecial 52	android/graphics/Canvas:<init>	(Landroid/graphics/Bitmap;)V
    //   80: aload 4
    //   82: fconst_0
    //   83: fconst_0
    //   84: aload_0
    //   85: getfield 19	com/mixpanel/android/c/ap:b	Landroid/graphics/Paint;
    ...
    //   96: aload_0
    //   97: aconst_null
    //   98: putfield 21	com/mixpanel/android/c/ap:a	Landroid/graphics/Bitmap;
    //   101: goto -54 -> 47
    //   104: astore 4
    //   106: aload_0
    //   107: monitorexit
  ...
  public void a(android.graphics.Bitmap.CompressFormat paramCompressFormat, int paramInt, java.io.OutputStream paramOutputStream)
  {
    ...
    //   16: ifeq +13 -> 29
    //   19: aload_0
    //   20: getfield 21	com/mixpanel/android/c/ap:a	Landroid/graphics/Bitmap;
    ...
    //   56: astore_1
    //   57: aload_0
    //   58: getfield 21	com/mixpanel/android/c/ap:a	Landroid/graphics/Bitmap;
...
/* Location:              D:\Android\dex2jar-2.0\classes-dex2jar.jar!\com\mixpanel\android\c\ap.class
