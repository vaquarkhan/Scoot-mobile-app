  ...
  implements q
{
  ...
  public android.location.Location a()
  {
    ...
    //   14: aload_0
    //   15: getfield 15	com/google/android/gms/location/internal/s:a	Landroid/os/IBinder;
    //   18: bipush 7
    //   20: aload_2
    //   21: aload_3
    //   22: iconst_0
  ...
  public com.google.android.gms.location.ActivityRecognitionResult a(String paramString)
  {
    ...
    //   19: aload_0
    //   20: getfield 15	com/google/android/gms/location/internal/s:a	Landroid/os/IBinder;
    //   23: bipush 64
    //   25: aload_2
    //   26: aload_3
    //   27: iconst_0
    ...
    //   42: ifeq +24 -> 66
    //   45: getstatic 66	com/google/android/gms/location/ActivityRecognitionResult:CREATOR	Lcom/google/android/gms/location/a;
    //   48: aload_3
    //   49: invokevirtual 69	com/google/android/gms/location/a:createFromParcel	(Landroid/os/Parcel;)Ljava/lang/Object;
    //   52: checkcast 63	com/google/android/gms/location/ActivityRecognitionResult
    //   55: astore_1
    //   56: aload_3
  ...
  public void a(long paramLong, boolean paramBoolean, PendingIntent paramPendingIntent)
  {
    ...
    //   20: aload 6
    //   22: lload_1
    //   23: invokevirtual 74	android/os/Parcel:writeLong	(J)V
    //   26: iload_3
    //   27: ifeq +61 -> 88
    //   30: aload 6
    //   32: iload 5
    //   34: invokevirtual 78	android/os/Parcel:writeInt	(I)V
    //   37: aload 4
    //   39: ifnull +55 -> 94
    //   42: aload 6
    //   44: iconst_1
    //   45: invokevirtual 78	android/os/Parcel:writeInt	(I)V
    //   48: aload 4
    //   50: aload 6
    //   52: iconst_0
    //   53: invokevirtual 84	android/app/PendingIntent:writeToParcel	(Landroid/os/Parcel;I)V
    //   56: aload_0
    //   57: getfield 15	com/google/android/gms/location/internal/s:a	Landroid/os/IBinder;
    //   60: iconst_5
    //   61: aload 6
    //   63: aload 7
    //   65: iconst_0
    ...
    //   94: aload 6
    //   96: iconst_0
    //   97: invokevirtual 78	android/os/Parcel:writeInt	(I)V
    //   100: goto -44 -> 56
    //   103: astore 4
    //   105: aload 7
  ...
  public void a(PendingIntent paramPendingIntent)
  {
    ...
    //   24: aload_2
    //   25: iconst_0
    //   26: invokevirtual 84	android/app/PendingIntent:writeToParcel	(Landroid/os/Parcel;I)V
    //   29: aload_0
    //   30: getfield 15	com/google/android/gms/location/internal/s:a	Landroid/os/IBinder;
    //   33: bipush 6
    //   35: aload_2
    //   36: aload_3
    //   37: iconst_0
  ...
  public void a(PendingIntent paramPendingIntent, dc paramdc)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramPendingIntent != null)
        {
          ...
          if (paramdc != null)
          {
            paramPendingIntent = paramdc.asBinder();
  ...
  public void a(PendingIntent paramPendingIntent, n paramn, String paramString)
  {
    Parcel localParcel1 = Parcel.obtain();
    Parcel localParcel2 = Parcel.obtain();
    for (;;)
    {
      try
      {
        ...
        if (paramPendingIntent != null)
        {
          ...
          if (paramn != null)
          {
            paramPendingIntent = paramn.asBinder();
            localParcel1.writeStrongBinder(paramPendingIntent);
  ...
  public void a(android.location.Location paramLocation)
  {
    ...
    //   24: aload_2
    //   25: iconst_0
    //   26: invokevirtual 101	android/location/Location:writeToParcel	(Landroid/os/Parcel;I)V
    //   29: aload_0
    //   30: getfield 15	com/google/android/gms/location/internal/s:a	Landroid/os/IBinder;
    //   33: bipush 13
    //   35: aload_2
  ...
  public void a(android.location.Location paramLocation, int paramInt)
  {
    ...
    //   19: aload_3
    //   20: iconst_1
    //   21: invokevirtual 78	android/os/Parcel:writeInt	(I)V
    //   24: aload_1
    //   25: aload_3
    //   26: iconst_0
    //   27: invokevirtual 101	android/location/Location:writeToParcel	(Landroid/os/Parcel;I)V
    //   30: aload_3
    //   31: iload_2
    //   32: invokevirtual 78	android/os/Parcel:writeInt	(I)V
    //   35: aload_0
    //   36: getfield 15	com/google/android/gms/location/internal/s:a	Landroid/os/IBinder;
    //   39: bipush 26
    //   41: aload_3
    //   42: aload 4
    //   44: iconst_0
    ...
    //   66: aload_3
    //   67: iconst_0
    //   68: invokevirtual 78	android/os/Parcel:writeInt	(I)V
    //   71: goto -41 -> 30
    //   74: astore_1
    //   75: aload 4
    //   77: invokevirtual 57	android/os/Parcel:recycle	()V
  ...
  public void a(ActivityRecognitionRequest paramActivityRecognitionRequest, PendingIntent paramPendingIntent, dc paramdc)
  {
    Parcel localParcel1 = Parcel.obtain();
    Parcel localParcel2 = Parcel.obtain();
    for (;;)
      ...
      try
      {
        ...
        if (paramActivityRecognitionRequest != null)
        {
          ...
          if (paramPendingIntent != null)
          {
            ...
            paramActivityRecognitionRequest = paramdc.asBinder();
  ...
  public void a(GeofencingRequest paramGeofencingRequest, PendingIntent paramPendingIntent, n paramn)
  {
    Parcel localParcel1 = Parcel.obtain();
    Parcel localParcel2 = Parcel.obtain();
    for (;;)
      ...
      try
      {
        ...
        if (paramGeofencingRequest != null)
        {
          ...
          if (paramPendingIntent != null)
          {
            ...
            paramGeofencingRequest = paramn.asBinder();
  ...
  public void a(GestureRequest paramGestureRequest, PendingIntent paramPendingIntent, dc paramdc)
  {
    Parcel localParcel1 = Parcel.obtain();
    Parcel localParcel2 = Parcel.obtain();
    for (;;)
      ...
      try
      {
        ...
        if (paramGestureRequest != null)
        {
          ...
          if (paramPendingIntent != null)
          {
            ...
            paramGestureRequest = paramdc.asBinder();
  ...
  public void a(LocationRequest paramLocationRequest, u paramu)
  {
    Parcel localParcel1 = Parcel.obtain();
    Parcel localParcel2 = Parcel.obtain();
    for (;;)
    {
      try
      {
        ...
        if (paramLocationRequest != null)
        {
          ...
          if (paramu != null)
          {
            paramLocationRequest = paramu.asBinder();
  ...
  public void a(LocationRequest paramLocationRequest, u paramu, String paramString)
  {
    Parcel localParcel1 = Parcel.obtain();
    Parcel localParcel2 = Parcel.obtain();
    for (;;)
  ...
  public void a(LocationSettingsRequest paramLocationSettingsRequest, t paramt, String paramString)
  {
    Parcel localParcel1 = Parcel.obtain();
    Parcel localParcel2 = Parcel.obtain();
    for (;;)
    {
      try
      {
        ...
        if (paramLocationSettingsRequest != null)
        {
          ...
          if (paramt != null)
          {
            paramLocationSettingsRequest = paramt.asBinder();
  ...
  public void a(LocationRequestInternal paramLocationRequestInternal, u paramu)
  {
    Parcel localParcel1 = Parcel.obtain();
    Parcel localParcel2 = Parcel.obtain();
    for (;;)
    {
      try
      {
        ...
        if (paramLocationRequestInternal != null)
        {
          ...
          if (paramu != null)
          {
            paramLocationRequestInternal = paramu.asBinder();
  ...
  public void a(LocationRequestUpdateData paramLocationRequestUpdateData)
  {
    ...
    //   24: aload_2
    //   25: iconst_0
    //   26: invokevirtual 139	com/google/android/gms/location/internal/LocationRequestUpdateData:writeToParcel	(Landroid/os/Parcel;I)V
    //   29: aload_0
    //   30: getfield 15	com/google/android/gms/location/internal/s:a	Landroid/os/IBinder;
    //   33: bipush 59
    //   35: aload_2
  ...
  public void a(k paramk)
  {
    ...
    //   30: aload_0
    //   31: getfield 15	com/google/android/gms/location/internal/s:a	Landroid/os/IBinder;
    //   34: bipush 67
    //   36: aload_2
    //   37: aload_3
    //   38: iconst_0
  ...
  public void a(n paramn, String paramString)
  {
    ...
    //   26: aload_3
    //   27: aload_1
    //   28: invokevirtual 95	android/os/Parcel:writeStrongBinder	(Landroid/os/IBinder;)V
    //   31: aload_3
    //   32: aload_2
    //   33: invokevirtual 61	android/os/Parcel:writeString	(Ljava/lang/String;)V
    //   36: aload_0
    //   37: getfield 15	com/google/android/gms/location/internal/s:a	Landroid/os/IBinder;
    //   40: iconst_4
    //   41: aload_3
    //   42: aload 4
    //   44: iconst_0
  ...
  public void a(List<ParcelableGeofence> paramList, PendingIntent paramPendingIntent, n paramn, String paramString)
  {
    Parcel localParcel1 = Parcel.obtain();
    Parcel localParcel2 = Parcel.obtain();
    for (;;)
  ...
  /* Error */
  public void a(String[] paramArrayOfString, n paramn, String paramString)
  {
    // Byte code:
    //   0: invokestatic 23	android/os/Parcel:obtain	()Landroid/os/Parcel;
    //   3: astore 4
    ...
    //   17: aload 4
    //   19: aload_1
    //   20: invokevirtual 158	android/os/Parcel:writeStringArray	([Ljava/lang/String;)V
    //   23: aload_2
    //   24: ifnull +54 -> 78
    //   27: aload_2
    ...
    //   34: aload 4
    //   36: aload_1
    //   37: invokevirtual 95	android/os/Parcel:writeStrongBinder	(Landroid/os/IBinder;)V
    //   40: aload 4
    //   42: aload_3
    //   43: invokevirtual 61	android/os/Parcel:writeString	(Ljava/lang/String;)V
    //   46: aload_0
    //   47: getfield 15	com/google/android/gms/location/internal/s:a	Landroid/os/IBinder;
    //   50: iconst_3
    //   51: aload 4
    //   53: aload 5
    //   55: iconst_0
  ...
  public void b(PendingIntent paramPendingIntent, dc paramdc)
  {
    Parcel localParcel1 = Parcel.obtain();
    Parcel localParcel2 = Parcel.obtain();
    for (;;)
  ...
  public com.google.android.gms.location.LocationAvailability c(String paramString)
  {
    ...
    //   39: invokevirtual 42	android/os/Parcel:readInt	()I
    //   42: ifeq +24 -> 66
    //   45: getstatic 167	com/google/android/gms/location/LocationAvailability:CREATOR	Lcom/google/android/gms/location/f;
    //   48: aload_3
    //   49: invokevirtual 170	com/google/android/gms/location/f:createFromParcel	(Landroid/os/Parcel;)Ljava/lang/Object;
    //   52: checkcast 164	com/google/android/gms/location/LocationAvailability
    //   55: astore_1
    //   56: aload_3
    //   57: invokevirtual 57	android/os/Parcel:recycle	()V
    //   60: aload_2
  ...
  public void c(PendingIntent paramPendingIntent, dc paramdc)
  {
    Parcel localParcel1 = Parcel.obtain();
    Parcel localParcel2 = Parcel.obtain();
    for (;;)
  ...
  public void d(PendingIntent paramPendingIntent, dc paramdc)
  {
    Parcel localParcel1 = Parcel.obtain();
    Parcel localParcel2 = Parcel.obtain();
    for (;;)
  ...
  public void e(PendingIntent paramPendingIntent, dc paramdc)
  {
    Parcel localParcel1 = Parcel.obtain();
    Parcel localParcel2 = Parcel.obtain();
    for (;;)
...
/* Location:              D:\Android\dex2jar-2.0\classes-dex2jar.jar!\com\google\android\gms\location\internal\s.class
