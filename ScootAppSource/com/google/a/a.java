...
final class a
  implements ae<java.util.Date>, v<java.util.Date>
{
  ...
  public w a(java.util.Date paramDate, Type arg2, ad paramad)
  {
    synchronized (this.b)
    {
      paramDate = new ac(this.a.format(paramDate));
      return paramDate;
    }
  }
...
/* Location:              D:\Android\dex2jar-2.0\classes-dex2jar.jar!\com\google\a\a.class
