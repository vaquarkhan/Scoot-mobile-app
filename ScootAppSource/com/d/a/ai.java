  ...
  implements Cloneable
{
  ...
  public static ai a(c<?, Float> paramc, float... paramVarArgs)
  {
  ...
  public static ai a(String paramString, o... paramVarArgs)
  {
    r localr = r.a(paramVarArgs);
    if ((localr instanceof n)) {
      return new al(paramString, (n)localr);
    }
    if ((localr instanceof l)) {
      return new ak(paramString, (l)localr);
    }
    paramString = new ai(paramString);
    paramString.e = localr;
...
/* Location:              D:\Android\dex2jar-2.0\classes-dex2jar.jar!\com\d\a\ai.class
