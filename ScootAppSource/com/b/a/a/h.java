  ...
  implements k
{
  ...
  static HttpUriRequest b(r<?> paramr, Map<String, String> paramMap)
  {
    switch (paramr.a())
    {
    default: 
    ...
    case 0: 
      return new HttpGet(paramr.d());
    case 3: 
      return new HttpDelete(paramr.d());
    case 1: 
  ...
  {
    HttpUriRequest localHttpUriRequest = b(paramr, paramMap);
...
/* Location:              D:\Android\dex2jar-2.0\classes-dex2jar.jar!\com\b\a\a\h.class
