  ...
  private static String inet6AddressToAscii(byte[] paramArrayOfByte)
  {
    ...
    while (i < paramArrayOfByte.length) {
      ...
      else
      {
        ...
        localf.i((paramArrayOfByte[i] & 0xFF) << 8 | paramArrayOfByte[(i + 1)] & 0xFF);
        i += 2;
      }
    }
    return localf.q();
...
/* Location:              D:\Android\dex2jar-2.0\classes-dex2jar.jar!\com\squareup\okhttp\HttpUrl$Builder.class
