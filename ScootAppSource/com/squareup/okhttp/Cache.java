...
public final class Cache
{
  ...
  private static int readInt(j paramj)
  {
    long l;
    try
    {
      l = paramj.n();
      paramj = paramj.r();
      if ((l < 0L) || (l > 2147483647L) || (!paramj.isEmpty())) {
        throw new IOException("expected an int but was \"" + l + paramj + "\"");
      }
    }
    catch (NumberFormatException paramj)
    {
      throw new IOException(paramj.getMessage());
    }
    return (int)l;
  }
...
/* Location:              D:\Android\dex2jar-2.0\classes-dex2jar.jar!\com\squareup\okhttp\Cache.class
