...
public final class HttpUrl
{
  ...
  static String canonicalize(String paramString1, int paramInt1, int paramInt2, String paramString2, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    while (i < paramInt2)
    {
      ...
      if ((j < 32) || (j == 127) || ((j >= 128) && (paramBoolean3)) || (paramString2.indexOf(j) != -1) || ((j == 37) && (!paramBoolean1)) || ((j == 43) && (paramBoolean2)))
      {
        ...
        canonicalize(localf, paramString1, i, paramInt2, paramString2, paramBoolean1, paramBoolean2, paramBoolean3);
        return localf.q();
      }
  ...
  static void canonicalize(f paramf, String paramString1, int paramInt1, int paramInt2, String paramString2, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
  ...
  static String percentDecode(String paramString, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    while (i < paramInt2)
    {
      ...
      if ((j == 37) || ((j == 43) && (paramBoolean)))
      {
        ...
        percentDecode(localf, paramString, i, paramInt2, paramBoolean);
        return localf.q();
      }
      i += 1;
    }
  ...
  static void percentDecode(f paramf, String paramString, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    if (paramInt1 < paramInt2)
    {
...
/* Location:              D:\Android\dex2jar-2.0\classes-dex2jar.jar!\com\squareup\okhttp\HttpUrl.class
