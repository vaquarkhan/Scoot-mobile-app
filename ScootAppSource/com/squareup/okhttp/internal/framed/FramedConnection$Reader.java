  ...
  implements FrameReader.Handler
{
  ...
  public void alternateService(int paramInt1, String paramString1, k paramk, String paramString2, int paramInt2, long paramLong) {}
  
  public void data(boolean paramBoolean, int paramInt1, j paramj, int paramInt2)
  {
    if (FramedConnection.access$1300(this.this$0, paramInt1)) {
      FramedConnection.access$1400(this.this$0, paramInt1, paramj, paramInt2, paramBoolean);
    }
    ...
    do
    {
      ...
      localFramedStream.receiveData(paramj, paramInt2);
    } while (!paramBoolean);
  ...
  public void goAway(int paramInt, ErrorCode arg2, k paramk)
  {
    if (paramk.f() > 0) {}
    synchronized (this.this$0)
    {
      paramk = (FramedStream[])FramedConnection.access$1900(this.this$0).values().toArray(new FramedStream[FramedConnection.access$1900(this.this$0).size()]);
...
/* Location:              D:\Android\dex2jar-2.0\classes-dex2jar.jar!\com\squareup\okhttp\internal\framed\FramedConnection$Reader.class
