  ...
  implements ac
{
  ...
  private void emitDataFrame(boolean paramBoolean)
  {
    ...
    //   112: aload_0
    //   113: getfield 42	com/squareup/okhttp/internal/framed/FramedStream$FramedDataSink:sendBuffer	Ld/f;
    //   116: invokevirtual 82	d/f:a	()J
    ...
    //   175: lload_3
    //   176: aload_0
    //   177: getfield 42	com/squareup/okhttp/internal/framed/FramedStream$FramedDataSink:sendBuffer	Ld/f;
    //   180: invokevirtual 82	d/f:a	()J
    //   183: lcmp
    //   184: ifne +28 -> 212
    //   187: iconst_1
    //   188: istore_1
    ...
    //   192: iload_1
    //   193: aload_0
    //   194: getfield 42	com/squareup/okhttp/internal/framed/FramedStream$FramedDataSink:sendBuffer	Ld/f;
    //   197: lload_3
    //   198: invokevirtual 102	com/squareup/okhttp/internal/framed/FramedConnection:writeData	(IZLd/f;J)V
    //   201: aload_0
  ...
  {
    assert (!Thread.holdsLock(this.this$0));
    this.sendBuffer.write(paramf, paramLong);
...
/* Location:              D:\Android\dex2jar-2.0\classes-dex2jar.jar!\com\squareup\okhttp\internal\framed\FramedStream$FramedDataSink.class
