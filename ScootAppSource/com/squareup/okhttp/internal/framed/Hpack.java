...
final class Hpack
{
  private static final Map<k, Integer> NAME_TO_FIRST_INDEX = nameToFirstIndex();
  ...
  private static k checkLowercase(k paramk)
  {
    int i = 0;
    int j = paramk.f();
    while (i < j)
    {
      int k = paramk.a(i);
      if ((k >= 65) && (k <= 90)) {
        throw new IOException("PROTOCOL_ERROR response malformed: mixed case name: " + paramk.a());
      }
      i += 1;
    }
    return paramk;
  ...
  private static Map<k, Integer> nameToFirstIndex()
  {
...
/* Location:              D:\Android\dex2jar-2.0\classes-dex2jar.jar!\com\squareup\okhttp\internal\framed\Hpack.class
