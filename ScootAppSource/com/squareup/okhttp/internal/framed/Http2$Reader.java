  ...
  implements FrameReader
{
  ...
  Http2$Reader(j paramj, int paramInt, boolean paramBoolean)
  {
    this.source = paramj;
  ...
  private void readGoAway(FrameReader.Handler paramHandler, int paramInt1, byte paramByte, int paramInt2)
  {
    ...
    k localk = k.b;
    if (paramInt1 > 0) {
      localk = this.source.c(paramInt1);
    }
    paramHandler.goAway(paramByte, localErrorCode, localk);
  }
  ...
  private void readHeaders(FrameReader.Handler paramHandler, int paramInt1, byte paramByte, int paramInt2)
  {
    ...
    label108:
    for (short s = (short)(this.source.i() & 0xFF);; s = 0)
    {
      int i = paramInt1;
      if ((paramByte & 0x20) != 0)
      {
  ...
  private void readPushPromise(FrameReader.Handler paramHandler, int paramInt1, byte paramByte, int paramInt2)
  {
    ...
    paramHandler.pushPromise(paramInt2, this.source.k() & 0x7FFFFFFF, readHeaderBlock(Http2.access$400(paramInt1 - 4, paramByte, s), s, paramByte, paramInt2));
  }
  ...
  public boolean nextFrame(FrameReader.Handler paramHandler)
  {
    ...
    byte b2 = (byte)(this.source.i() & 0xFF);
  ...
  public void readConnectionPreface()
  {
    ...
    {
      return;
      localk = this.source.c(Http2.access$000().f());
      if (Http2.access$100().isLoggable(Level.FINE)) {
        Http2.access$100().fine(String.format("<< CONNECTION %s", new Object[] { localk.d() }));
      }
    } while (Http2.access$000().equals(localk));
    throw Http2.access$200("Expected a connection header but was %s", new Object[] { localk.a() });
  }
}


/* Location:              D:\Android\dex2jar-2.0\classes-dex2jar.jar!\com\squareup\okhttp\internal\framed\Http2$Reader.class
