  ...
  implements k
{
  ...
  private static Map<String, Object> a(InputStream paramInputStream)
  {
    ...
    //   3: dup
    //   4: invokespecial 125	java/util/concurrent/ConcurrentHashMap:<init>	()V
    //   7: astore_1
    //   8: new 127	java/io/DataInputStream
    //   11: dup
    //   12: aload_0
    //   13: invokespecial 130	java/io/DataInputStream:<init>	(Ljava/io/InputStream;)V
    //   16: astore_0
    //   17: aload_0
    //   18: aload_1
    //   19: invokestatic 133	e/b/a/e/m:a	(Ljava/io/DataInputStream;Ljava/util/Map;)V
    //   22: aload_0
    ...
    //   32: dup
    //   33: getstatic 145	e/b/a/i:a	Le/b/a/i;
    //   36: invokespecial 148	java/lang/ref/SoftReference:<init>	(Ljava/lang/Object;)V
    //   39: invokeinterface 152 3 0
    //   44: pop
    //   45: aload_1
    //   46: areturn
    //   47: astore_1
    //   48: aload_0
    //   49: invokevirtual 136	java/io/DataInputStream:close	()V
    //   52: aload_1
    //   53: athrow
    //   54: astore_0
    //   55: goto -29 -> 26
  ...
  private i c(String paramString)
  {
    ...
    //   0: aload_0
    //   1: aload_1
    //   2: invokespecial 71	e/b/a/e/m:b	(Ljava/lang/String;)Ljava/io/InputStream;
    //   5: astore_3
    //   6: aload_3
    //   7: astore_2
    //   8: aload_3
    //   9: aload_1
    //   10: invokestatic 204	e/b/a/e/c:a	(Ljava/io/InputStream;Ljava/lang/String;)Le/b/a/i;
    //   13: astore 4
    //   15: aload_3
    //   16: astore_2
    //   17: aload_0
    //   18: getfield 76	e/b/a/e/m:d	Ljava/util/Map;
    //   21: aload_1
    //   22: new 140	java/lang/ref/SoftReference
    //   25: dup
    //   26: aload 4
    //   28: invokespecial 148	java/lang/ref/SoftReference:<init>	(Ljava/lang/Object;)V
    //   31: invokeinterface 152 3 0
    //   36: pop
    //   37: aload_3
    //   38: ifnull +7 -> 45
    //   41: aload_3
    //   42: invokevirtual 207	java/io/InputStream:close	()V
    //   45: aload 4
    //   47: areturn
    //   48: astore 4
    //   50: aconst_null
    ...
    //   54: aload_0
    //   55: aload 4
    //   57: invokevirtual 210	e/b/a/e/m:a	(Ljava/lang/Exception;)V
    //   60: aload_3
    //   61: astore_2
    //   62: aload_0
    //   63: getfield 76	e/b/a/e/m:d	Ljava/util/Map;
    //   66: aload_1
    //   67: invokeinterface 214 2 0
    //   72: pop
    //   73: aload_3
    //   74: ifnull +7 -> 81
    //   77: aload_3
    //   78: invokevirtual 207	java/io/InputStream:close	()V
    //   81: aconst_null
    //   82: areturn
    //   83: astore_1
    //   84: aconst_null
...
/* Location:              D:\Android\dex2jar-2.0\classes-dex2jar.jar!\e\b\a\e\m.class
