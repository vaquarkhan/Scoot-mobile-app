  ...
  extends i
{
  ...
  public boolean equals(Object paramObject)
  {
    ...
    do
    {
      ...
      if ((!e().equals(((f)paramObject).e())) || (!Arrays.equals(this.b, ((f)paramObject).b)) || (!Arrays.equals(this.e, ((f)paramObject).e)) || (!Arrays.equals(this.c, ((f)paramObject).c)) || (!Arrays.equals(this.d, ((f)paramObject).d))) {
        break;
      }
      if (this.f != null) {
        break label105;
...
/* Location:              D:\Android\dex2jar-2.0\classes-dex2jar.jar!\e\b\a\e\f.class
